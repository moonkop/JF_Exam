...
public class StudentController extends BaseController
{
    ...
    {
        SchoolVo schoolVo = schoolEbi.get(schoolID);
        ClassroomVo classroomVo = classroomEbi.get(classroomID);
        TroleVo troleVo = roleEbi.get(roleID);
        studentVo.setRole(troleVo);
