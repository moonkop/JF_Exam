        ...
        <div class="panel">
            <div class="panel-body">
                <div class="text-right">
                    ...
                    <button class="btn btn-primary js-enter-exam">
                        开始考试
                    </button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".js-enter-exam").hide();
        var timerStart = setInterval(checkTime, 1000);
        checkTime();
        ...
        $(".js-enter-exam").on("click",function () {
window.location.href="/exam/student/workout?id="+app.exam.studentExam.id;
        })
    });
